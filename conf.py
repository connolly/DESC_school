...
BLOG_TITLE = "Introduction to AstroML"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://connolly.github.io/introAstroML/"
# This is the URL where nikola's output will be deployed.
# If not set, defaults to SITE_URL
BLOG_EMAIL = "ajc@astro.washington.edu"
BLOG_DESCRIPTION = "A set of lectures introducing AstroML"  # (translatable)
